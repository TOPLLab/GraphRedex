 ...
 */
    ...
    function visualise(data) {
        ...
        const links = data.edges
            ...
            .map(d => ({source: d._from, target: d._to, reduction: d.reduction, real: d._real, data: d}));
    ...
    function forceSimulation(nodes, links) {
        return d3.forceSimulation(nodes)
            .force("link", d3.forceLink(links).distance(d => d.real ? 60 : 90).strength(1.5).id(d => d.id))
